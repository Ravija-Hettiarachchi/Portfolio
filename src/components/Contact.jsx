    ...
    <section id="contact" ref={revealRef} className="relative px-4 py-16 sm:px-6 sm:py-24 overflow-hidden border-t border-white/5">
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        ...
        <div className="text-center space-y-4 mb-16">
          <p className="reveal-on-scroll delay-100 text-xs uppercase tracking-[0.5em] text-[#ff8a3d]">Get In Touch</p>
          <h2 className="reveal-on-scroll delay-200 text-3xl font-bold text-white sm:text-4xl">Let's connect & collaborate</h2>
          <p className="reveal-on-scroll delay-300 mx-auto max-w-2xl text-sm sm:text-base text-white/65">
            Drop a message in the secure gateway below to start a new project, inquire about opportunities, or just say hello.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-stretch">
          ...
          <BorderGlow
            ...
            glowIntensity={1.2}
            coneSpread={24}
            colors={['#ff7a32', '#ffa149', '#ff8a3d']}
            className="lg:col-span-5 w-full h-full"
            fillOpacity={0.06}
          >
            <div className="flex flex-col justify-between h-full space-y-8 p-8 sm:p-10 relative overflow-hidden">
          ...
          <div className="lg:col-span-7 relative">
            ...
            >
              <div
                ...
                className="h-full relative px-8 py-10 sm:p-12"
              >
